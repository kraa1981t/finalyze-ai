...
export default function SuggestionsPage({ lang, onBack, userName }: SuggestionsPageProps) {
  const isAr = lang === 'ar';
      ...
      {loading ? (
        ...
        <div className="text-center py-12 space-y-3">
          ...
          <p className="text-white/40 text-sm">
            {isAr ? 'لا توجد اقتراحات بعد. كن أول من يقترح!' : 'No suggestions yet. Be the first to suggest!'}
          </p>
        </div>
      ) : (
